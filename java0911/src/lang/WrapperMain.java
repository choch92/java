...
public class WrapperMain {
	...
	public static void main(String[] args) {
		...
		System.out.printf("================\n");
		// double은 소수 15자리까지만 인식을 합니다.
		// 아래의 경우는 더하면 2.0이 됩니다.
		double d1 = 1.0000000000000000000000000001;
		double d2 = 1.000000000000000000000000003;
		System.out.println(d1 + d2);
		
		//위의 연산을 BigDecimal로 해결 
		BigDecimal b1 = new BigDecimal("1.0000000000000000000000000001");
		BigDecimal b2 = new BigDecimal("1.000000000000000000000000003");
