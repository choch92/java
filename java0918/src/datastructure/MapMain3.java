...
public class MapMain3 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("=======================================\n");
		// 배열들을 가지고 배열을 만들 때는 분류를 위해서 각 배열들을 Map으로 만들고 그 Map들의 배열을 만들어야 합니다.
		...
		for(int i=0;i<football.length;i=i+1) {
			...
			// 출력을 제외하고 사용을 할 때는 원래의 자료형으로 변환해서 사용해야 합니다.
